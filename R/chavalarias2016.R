#' P-values from Chavalarias et al. 2016 JAMA, please see vignette
#' for more details about how the data were collected and processed.
#'
#'
#' @format A data frame with 3,286,391 rows and 8 columns
#' \describe{
...
#' }
#' @source \url{https://jamanetwork.com/journals/jama/fullarticle/10.1001/jama.2016.1952}
"chavalarias2016"